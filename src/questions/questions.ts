...
export const QUESTIONS: Array<IQuestion> = [
  {
    id: 1,
    image: images.im1_1,
    answers: ['потерять волосы', 'сломать спину', 'спустить деньги', 'обрести славу'], // 2
  ...
  },
  {
    id: 6,
    image: images.im6_1,
    answers: ['курильщика', 'для базы приехала!', 'здорового барабанщика', 'Золотая - любимое пиво!'], // 3
    correctAnswer: images.im6_2
  },
  {
    id: 7,
    image: images.im7_1,
    answers: ['...ая ты хорошка', 'ты подпеваешь', 'я налажал в партии', 'ты радуешься концерту'], // 1
